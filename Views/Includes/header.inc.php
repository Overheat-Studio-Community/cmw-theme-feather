...
<nav class="bg-transparent text-white dark:text-gray-300 p-4 flex justify-between items-center relative z-10">
    <div class="flex lg:flex">
        <?= Website::getWebsiteName() ?>
    </div>

    <ul class="!important hidden lg:flex lg:gap-x-12">
